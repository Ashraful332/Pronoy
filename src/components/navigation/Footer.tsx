...
export default function Footer(){
      return(
      <footer className="max-w-[1170px] flex flex-col xl:flex-row items-center xl:items-start gap-12 xl:gap-o justify-between m-auto pb-[var(--margin-primary)] pt-[var(--margin-primary)] ">
