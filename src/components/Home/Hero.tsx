             ...
             px-[14px] sm:px-[30px] spacer layer1 ">
                  <div ref={heroRef} className=" w-[97%] sm:w-[600px] flex flex-col items-center lg:items-start ">
                        ...
                        <p className="mb-5 font-bold ">
                              A passionate teacher and skilled IT expert from Kuripara High School, Narayanganj, Bangladesh. Dedicated to sharing knowledge, guiding students, and inspiring young minds through education and technology for a brighter future.
                        </p>
                        <p className="font-medium italic">
                              An experienced IT expert and dedicated teacher at Kuripara High School, Narayanganj, Bangladesh, passionate about technology and education.                        </p>
