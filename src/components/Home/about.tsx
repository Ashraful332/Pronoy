...
export default function AboutMe(){
    return(
        <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start justify-center gap-10 lg:gap-[8%] mx-auto pt-[70px] px-[14px] sm:px-[30px] spacer layer2 ">
