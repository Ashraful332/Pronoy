        ...
        <div className="flex-center pt-[var(--margin-high)] pb-6 w-[97%] sm:w-[80vw] lg:w-[70vw] xl:w-[60vw] mx-auto px-[14px] sm:px-[30px]   ">
            ...
            <div className=" columns-1 sm:columns-2 lg:columns-3 gap-2">
                <div className="block mb-2 ">
                    <Image src={My1} alt="my photo" className="w-[360px] " />
                </div>
                <div className="block mb-2 ">
                    <Image src={My2} alt="my photo" className="w-[360px] " />
                </div>
                <div className="block mb-2 ">
                    <Image src={My3} alt="my photo" className="w-[360px] " />
                </div>
                <div className="block mb-2 ">
                    <Image src={My4} alt="my photo" className="w-[360px] " />
                </div>
                <div className="block mb-2 ">
                    <Image src={My5} alt="my photo" className="w-[360px] " />
                </div>
                <div className="block mb-2 ">
                    <Image src={My6} alt="my photo" className="w-[360px] " />
                </div>
            </div>
        </div>
    </div>
